...
#include "m_IpdRkU6aI7ydTFaaTl0kiC.h"
#include <emmintrin.h>
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__setup(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
...
static robotics_manip_internal_RigidBody *f_RigidBody_RigidBody(const emlrtStack
  *sp, robotics_manip_internal_RigidBody *obj);
static void mw__internal__call__reset(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
...
static void emxEnsureCapacity_cell_wrap(emxArray_cell_wrap *emxArray, int32_T
  oldNumel);
static void init_simulink_io_address(InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC
  *moduleInstance);
  ...
  *moduleInstance, const emlrtStack *sp, real_T b_u0[5], real_T c_y0[30])
{
  ...
  static char_T b_a[7] = { 'L', 'i', 'n', 'k', ' ', 'B', 'l' };
...
/* CGXE Glue Code */
static void mdlOutputs_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S, int_T tid)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S, int_T tid)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S)
{
  InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *moduleInstance =
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC *)calloc(1, sizeof
    (InstanceStruct_IpdRkU6aI7ydTFaaTl0kiC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_IpdRkU6aI7ydTFaaTl0kiC);
  ssSetmdlInitializeConditions(S, mdlInitialize_IpdRkU6aI7ydTFaaTl0kiC);
  ssSetmdlUpdate(S, mdlUpdate_IpdRkU6aI7ydTFaaTl0kiC);
  ssSetmdlTerminate(S, mdlTerminate_IpdRkU6aI7ydTFaaTl0kiC);
  ssSetmdlEnable(S, mdlEnable_IpdRkU6aI7ydTFaaTl0kiC);
  ssSetmdlDisable(S, mdlDisable_IpdRkU6aI7ydTFaaTl0kiC);
...
static void mdlProcessParameters_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S)
{
}

void method_dispatcher_IpdRkU6aI7ydTFaaTl0kiC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_IpdRkU6aI7ydTFaaTl0kiC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_IpdRkU6aI7ydTFaaTl0kiC(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: IpdRkU6aI7ydTFaaTl0kiC.\n"
...
mxArray *cgxe_IpdRkU6aI7ydTFaaTl0kiC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_IpdRkU6aI7ydTFaaTl0kiC_fallback_info(void)
{
